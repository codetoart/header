...
class Header {
  ...
  render() {
    ...
    this.anchorInputField = document.createElement('div');
    this.anchorInputField.setAttribute("contenteditable", (this.readOnly) ? false : true);
    this.anchorInputField.placeholder = "Add anchor";
   
    // this.anchorInputField.value = this._anchor;
    this.anchorInputField.innerHTML = this._anchor;
